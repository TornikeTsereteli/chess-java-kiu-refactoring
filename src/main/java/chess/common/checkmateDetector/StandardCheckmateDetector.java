...
public class StandardCheckmateDetector implements CheckmateDetector{
    ...
    /**
     * Constructs a new instance of chess.model.CheckmateDetector on a given board. By
     ...
     * @param wk chess.model.Piece object representing the white king
     * @param bk chess.model.Piece object representing the black king
     */
    public StandardCheckmateDetector(Board b, LinkedList<Piece> wPieces,
...
//        movableSquares.removeAll(movableSquares);
     ...
     * @param p chess.model.Piece moved
     * @param sq chess.model.Square to which p is about to move
